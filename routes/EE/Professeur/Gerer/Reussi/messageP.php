...
<body>
  ...
  <?php 
  $req = $bdd->prepare('INSERT INTO professeur(NOM, PRENOMS, MATIERE, CONTRAT, TELEPHONE, SALAIRE) VALUES(:nom, :prenoms, :matiere, :contrat, :telephone, :salaire)');
  $req->execute(array(
    'nom' => $_POST['nom'],
  ...
  <div class="alert alert-success" role="alert">
    Le professeur a bien ete ajoute
  </div>

...
$reponse = $bdd->prepare('SELECT p.NUMERO num_professeur, p.NOM nom_professeur, p.PRENOMS prenom_professeur, p.MATIERE matiere_professeur, p.TELEPHONE telephone_professeur, p.SALAIRE salaire_professeur, c.TYPE contrat_type
FROM contrat c
...
<body>
	...
	<p id="ajouter"><a class="btn btn-info" href="../listeP.php">Retour</a><p>

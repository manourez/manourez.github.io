...
<body>
	...
	<form action="Reussi/messageP.php" method="POST">
		<div class="form-group row">
    		<label for="nom" class="col-sm-2 col-form-label">Nom</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du professeur" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="prenoms" class="col-sm-2 col-form-label">Prenoms</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="prenoms" name="prenoms" placeholder="Prenoms du professeur" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="matiere" class="col-sm-2 col-form-label">Matiere</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="matiere" name="matiere" placeholder="Matiere" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="contrat" class="col-sm-2 col-form-label">Type de contrat</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="contrat" name="contrat" placeholder="Numero de contrat(1 ou 2)" required="true">
    		</div>
  		</div>
  		<div class="form-group row">

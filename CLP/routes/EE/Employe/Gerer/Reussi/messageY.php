...
<body>
  ...
  <?php 
  $req = $bdd->prepare('INSERT INTO administration(NOM, PRENOMS, FONCTION, CONTRAT, TELEPHONE, SALAIRE) VALUES(:nom, :prenoms, :fonction, :contrat, :telephone, :salaire)');
  $req->execute(array(
    'nom' => $_POST['nom'],

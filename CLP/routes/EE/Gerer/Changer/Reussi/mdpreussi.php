...
<body>
  ...
  $req = $bdd->prepare('UPDATE admin SET PASSWORD = :nvpass WHERE PSEUDO = :pseudo');
  $req->execute(array(
    'nvpass' => $pass_hache,
  ...
  <div class="alert alert-success" role="alert">
    Le mot de passe a bien ete change
  </div>
  ...
  $req->closeCursor();
  ?>
  <p id="bouton"><a class="btn btn-info" href="../../moncompte.php">Retour</a><p>

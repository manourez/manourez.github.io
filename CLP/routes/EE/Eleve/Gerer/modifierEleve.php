...
$eleve_numero = $_GET['NUMERO'];
$req = $bdd->prepare('SELECT * FROM eleve WHERE NUMERO = :num');
$req->execute(array('num' => $eleve_numero));
$resultat = $req->fetch();
...
<body>
	...
	<form action="Reussi/messageEM.php" method="POST">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
  		...
  		<div class="form-group row">
    		...
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="age" name="age" placeholder="Age" value="<?php echo $resultat['AGE'] ?>" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="classe" class="col-sm-2 col-form-label">Numero de la classe</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="classe" name="classe" placeholder="Numero d'identifiant de la classe" value="<?php echo $resultat['CLASSE'] ?>" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="sexe" class="col-sm-2 col-form-label">Sexe</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="sexe" name="sexe" placeholder="Masculin ou Feminin" value="<?php echo $resultat['SEXE'] ?>" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<label for="affecte" class="col-sm-2 col-form-label">Affecte</label>
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="affecte" name="affecte" placeholder="Entrez OUI si affecte/ NON sinon" value="<?php echo $resultat['AFFECTE'] ?>" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<div class="col-sm-10">

...
<body>
	...
	<form action="Reussi/messageC.php" method="POST">
		<div class="form-group row">
  		...
  		<div class="form-group row">
    		...
    		<div class="col-sm-10">
      			<input type="text" class="form-control" id="effectif" name="effectif" placeholder="Effectif de la classe" required="true">
    		</div>
  		</div>
  		<div class="form-group row">
    		<div class="col-sm-10">
